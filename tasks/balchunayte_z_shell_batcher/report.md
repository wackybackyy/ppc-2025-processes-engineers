...
Последовательная версия служит базовой точкой отсчёта.  
MPI-реализация демонстрирует корректную работу, однако при небольших размерах данных ускорение ограничено накладными расходами на:
- `MPI_Scatterv`;
- коммуникации при слиянии;
- рассылку итогового результата.

Для больших массивов и распределённых систем ожидается более заметный выигрыш.
